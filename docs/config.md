...
Per-project `deadLetter`, `inputQuality`, `qualityGate`, `review`, `advisor`, `sla`,
and `telemetry` mirror their [Run defaults](#run-defaults) counterparts and override them.
